  ...
  <div
    ...
    <div
      ...
      <div class="text-center mb-8 flex flex-col items-center">
        ...
        <h1 class="text-4xl font-extrabold text-kelola-lime tracking-tighter mb-1 drop-shadow-sm">Daftar Akun.</h1>
        <p class="text-kelola-lime font-semibold tracking-wide text-sm uppercase">Mulai kelola uangmu sekarang</p>
      </div>
      ...
      <p class="mt-6 text-center text-xs text-kelola-lime font-bold uppercase tracking-wide">
        Sudah punya akun?
